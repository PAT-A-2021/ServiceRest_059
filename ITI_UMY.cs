...
namespace ServiceRest_20190140059_Hakeem_Gufran
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_20190140059_Hakeem_Gufran.ContractType".
    [DataContract]
    ...
    {
        private string _nama, _nim, _prodi, _angkatan; //_adalah konversi atau kesepakatan // variable lokal
