...
namespace ServiceRest_20190140059_Hakeem_Gufran
{
    ...
    public class TI_UMY : ITI_UMY
    {
		...
		{
			string msg = "GAGAL";
			SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-7JB006G9\\HAKEEM;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=Blackshit26 ");
		...
		public List<Mahasiswa> GetAllMahasiswa()
		{
			...
			SqlConnection con = new SqlConnection("Data Source=LAPTOP-7JB006G9\\HAKEEM;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=Blackshit26 ");
